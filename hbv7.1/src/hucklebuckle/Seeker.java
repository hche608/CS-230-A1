...
class Seeker extends Player {
	...
	void seek() {
		...
		boolean moveRight = true; // I move left-to-right on the first row
									// (y==0)
		for (int y = 0; y < game.gridSize; y++) {
			...
			moveRight = !moveRight; // I move in the opposite direction on each
									// row of the grid.
			// My movement pattern is sometimes called the
			// "snake-like row major ordering".
